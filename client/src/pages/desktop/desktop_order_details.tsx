...
import './css/desktop_order_details.css';

type OrderId = {order_id: string | undefined};


const DesktopOrderDetails : React.FC<OrderId> = ({ order_id }) : React.JSX.Element => {
  ...
  return (
    <div className='desktop_order_details_container'>
